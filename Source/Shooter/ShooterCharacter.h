...
protected:
	...
	**/
	...
	void EquipWeapon( AWeapon* WeaponToEquipped, bool bSwapping = false);
	...
	//Called From Animation BP with Grab Anim notify
	UFUNCTION(BlueprintCallable)
	void GrabClip();

	// Called From Animation BP with Release Anim notify
	UFUNCTION(BlueprintCallable)
	void ReleaseClip();
...
private:
	...
	/* Montage for Equiping weapon */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Combat", meta = (AllowPrivateAccess = "true"))
	UAnimMontage* EquppingMontage;

	//Transform of the Clipwhere first grabing the clip
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Combat", meta = (AllowPrivateAccess = "true"))
	...
	//Regular MovementSpeed
	UPROPERTY(VisibleAnyWhere, BlueprintReadOnly, Category = "Movement", meta = (AllowPrivateAccess = "true"))
		float BaseMovementSpeed;

	//Crouched MovementSpeed
	UPROPERTY(VisibleAnyWhere, BlueprintReadOnly, Category = "Movement", meta = (AllowPrivateAccess = "true"))
	...
	// Ground Friction While Standing
	UPROPERTY(EditAnyWhere, BlueprintReadWrite, Category = "Movement", meta = (AllowPrivateAccess = "true"))
	...
	bool bShouldPlayEquipedSound;

	void RestPickupSoundTimer();
	void RestEquipSoundTimer();
	...
	// Dlegate for sending slot information to playing the icon animation
	UPROPERTY(BlueprintAssignable, Category = "Delegate", meta = (AllowPrivateAccess = "true"))
	FHighlightIconDelegate HighlightIconDelegate;

	// The inde for curntly highlighted slot
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Inventory", meta = (AllowPrivateAccess = "true"))
...
public:
	...
	FORCEINLINE bool ShouldPlayEquipedSound() const { return bShouldPlayEquipedSound; }

	void StartPickupSoundTimer();
	void StartEquipSoundTimer();

	void UnHiglightedInventorySlot();

	FORCEINLINE AWeapon* GetEquppedWeapon() const { return EquippedWeapon; }
